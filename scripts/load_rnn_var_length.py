...
simbolos = np.load(args.train_images_file)
simbolos_label = np.load(args.train_labels_file)
...
CONVNET = pickle.load(open(args.convnet_file))
...
n_input = args.n_input # salida de la red convolucional y entrada a la RNN
...
n_hidden = args.n_hidden # hidden layer num of features || tamano de la memoria
